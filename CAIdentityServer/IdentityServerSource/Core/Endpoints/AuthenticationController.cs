...
namespace IdentityServer3.Core.Endpoints
{
    ...
    internal class AuthenticationController : ApiController
    {
        ...
        private async Task<IHttpActionResult> RenderLoginPage(SignInMessage message, string signInMessageId, string errorMessage = null, string username = null, bool rememberMe = false)
        {
            ...
            var companyPortals = new System.Collections.Generic.List<CompanyPortal>();
            companyPortals.Add(new CompanyPortal { Id = 1, Name = "Medical Provider Portal" });
            companyPortals.Add(new CompanyPortal { Id = 2, Name = "Patient Portal" });
            companyPortals.Add(new CompanyPortal { Id = 3, Name = "Attorney Portal" });
            companyPortals.Add(new CompanyPortal { Id = 4, Name = "Collection Attorney Portal" });
            companyPortals.Add(new CompanyPortal { Id = 5, Name = "Funding Portal" });
            companyPortals.Add(new CompanyPortal { Id = 6, Name = "Ancillary Portal" });
