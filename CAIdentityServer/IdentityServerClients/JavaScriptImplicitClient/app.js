...
var settings = {
    authority: "https://lt007.codearray.tech/CAIdentityServer/core",
    client_id: "js.usermanager",
    redirect_uri: window.location.protocol + "//" + window.location.host + "/JavaScriptOidcClient/index.html",
    post_logout_redirect_uri: window.location.protocol + "//" + window.location.host + "/JavaScriptOidcClient/index.html",

    // these two will be done dynamically from the buttons clicked, but are
    // needed if you want to use the silent_renew
    response_type: "id_token token",
    scope: "openid profile email roles SampleWebAPI",
...
function callApi() {
    ...
    xhr.open("GET", "http://lt007.codearray.tech/SampleWebAPI/identity", true);
    if (user) {
