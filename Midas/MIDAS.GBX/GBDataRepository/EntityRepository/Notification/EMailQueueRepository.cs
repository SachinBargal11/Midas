...
{
    internal class EMailQueueRepository : BaseEntityRepo, IDisposable
    {
        public EMailQueueRepository(MIDASGBXEntities context) : base(context)
        {
        ...
        {
            List<BO.EMailSend> EMailSendBO = (from eMailQ in _context.EMailQueues
