...
namespace MIDAS.GBX.DataRepository.EntityRepository
{
    internal class DoctorLocationScheduleRepository : BaseEntityRepo, IDisposable
    {
        ...
        public override object DeleteAllAppointmentsandDoctorLocationSchedule<T>(T entity)
        {
            BO.DoctorLocationSchedule doctorlocationscheduleBO = entity as BO.DoctorLocationSchedule;
            int id = doctorlocationscheduleBO.ID;
            ...
            var acc = _context.PatientVisits.Include("CalendarEvent").Where(p => p.DoctorId == doctorlocationscheduleDB.DoctorID && p.CalendarEvent.EventStart >= currentDate && p.LocationId == doctorlocationscheduleDB.LocationID && (p.IsDeleted.HasValue == false || (p.IsDeleted.HasValue == true && p.IsDeleted.Value == false))).ToList<PatientVisit>();
        ...
        public override object Delete(int id)
        {
            ...
            var patientVisit = _context.PatientVisits.Include("CalendarEvent")
                                         .Include("Location")
                                         .Where(p => p.LocationId == doctorlocationscheduleDB.LocationID && p.DoctorId == doctorlocationscheduleDB.DoctorID && p.CalendarEvent.EventStart >= currentDate
                                                && (p.IsDeleted.HasValue == false || (p.IsDeleted.HasValue == true && p.IsDeleted.Value == false)))
                                         .ToList();
        ...
        public override object GetByDoctorId(int id)
        {
            ...
            var acc_ = _context.DoctorLocationSchedules.Include("Doctor").Include("Doctor.User")
                                                        ...
                                                        .Include("Location").Include("Location.AddressInfo").Include("Location.ContactInfo")
                                                        .Include("Schedule")
                                                        .Where(p => p.DoctorID == id && (p.IsDeleted == false || p.IsDeleted == null) && (p.Doctor.IsDeleted.HasValue == false || (p.Doctor.IsDeleted.HasValue == true && p.Doctor.IsDeleted.Value == false)) && (p.Doctor.User.IsDeleted.HasValue == false || (p.Doctor.User.IsDeleted.HasValue == true && p.Doctor.User.IsDeleted.Value == false))).ToList<DoctorLocationSchedule>();
            if (acc_ == null)
            {
                return new BO.ErrorObject { ErrorMessage = "No records found.", errorObject = "", ErrorLevel = ErrorLevel.Error };
            }
        ...
        public override object GetByDoctorAndCompanyId(int doctorId, int companyId)
        {
            ...
            var acc_ = _context.DoctorLocationSchedules.Include("Doctor").Include("Doctor.User")
                                                        ...
                                                        && (p.IsDeleted.HasValue == false || (p.IsDeleted.HasValue == true && p.IsDeleted.Value == false)) && (p.Doctor.IsDeleted.HasValue == false || (p.Doctor.IsDeleted.HasValue == true && p.Doctor.IsDeleted.Value == false)) && (p.Doctor.User.IsDeleted.HasValue == false || (p.Doctor.User.IsDeleted.HasValue == true && p.Doctor.User.IsDeleted.Value == false)))
                                                        .ToList<DoctorLocationSchedule>();
        ...
        public override object Get(int locationId, int doctorId)
        {
            ...
            var acc_ = _context.DoctorLocationSchedules.Include("Doctor").Include("Doctor.User")
                                                       .Include("Location").Include("Location.AddressInfo").Include("Location.ContactInfo")
                                                       .Include("Schedule").Where(p => (p.LocationID == locationId && p.DoctorID == doctorId) && (p.IsDeleted == false || p.IsDeleted == null) && (p.Doctor.IsDeleted.HasValue == false || (p.Doctor.IsDeleted.HasValue == true && p.Doctor.IsDeleted.Value == false)) && (p.Doctor.User.IsDeleted.HasValue == false || (p.Doctor.User.IsDeleted.HasValue == true && p.Doctor.User.IsDeleted.Value == false))).ToList<DoctorLocationSchedule>();
            if (acc_ == null)
            {
                return new BO.ErrorObject { ErrorMessage = "No records found.", errorObject = "", ErrorLevel = ErrorLevel.Error };
            }
