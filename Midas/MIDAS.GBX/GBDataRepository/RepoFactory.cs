...
namespace MIDAS.GBX
{
    internal class RepoFactory
    {
        internal static BaseEntityRepo GetRepo<T>(MIDASGBXEntities context)
        {
            ...
            else if (typeof(T) == typeof(BO.CompanyRoomTestDetails))
            {
                repo = new CompanyRoomTestDetailsRepository(context);
            }
            ...
            else if (typeof(T) == typeof(BO.MergePDF) || typeof(T) == typeof(BO.PacketDocument) || typeof(T) == typeof(BO.Document) || typeof(T) == typeof(BO.Common.UploadInfo))
            {
            ...
            else if (typeof(T) == typeof(BO.SearchMedicalProviders))
            {
            ...
            else if (typeof(T) == typeof(BO.InsuranceMasterType))
            {
                repo = new InsuranceMasterTypeRepository(context);
            }
            else if (typeof(T) == typeof(BO.MapUserToCompnay))
            {
                repo = new UserRepository(context);
            }
            else if (typeof(T) == typeof(BO.MapDoctorToCompnay))
            {
                repo = new DoctorRepository(context);
            }
            else if (typeof(T) == typeof(BO.DiagnosisTypeCompany))
            {
                repo = new DiagnosisTypeCompanyRepository(context);
            }

            else if (typeof(T) == typeof(BO.DiagnosisCodeCompanyMapping))
            {
