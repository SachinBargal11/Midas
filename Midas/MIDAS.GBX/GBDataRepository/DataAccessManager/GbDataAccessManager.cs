...
namespace MIDAS.GBX.DataAccessManager
{
    public class GbDataAccessManager<T> : IGbDataAccessManager<T>
    {
        ...
        public object DeleteAllAppointmentsandDoctorLocationSchedule(T entity)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());

                var res = baseRepo.DeleteAllAppointmentsandDoctorLocationSchedule(entity);
        ...
        public object DeleteObj(T gbObject)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());

                var res = baseRepo.DeleteObj(gbObject);
        ...
        public Object LoginWithUserName(T data, int? nestingLevels = default(int?), bool includeAllVersions = false, bool applySecurity = false)
        {
            try
            {
                if (data == null)
                ...
                {
                    var gbdata = baseRepo.LoginWithUserName(data);
                    return gbdata;
                }
            }
        ...
        public Object GenerateOTPForCompany(int CompanyId, int? nestingLevels, bool includeAllVersions, bool applySecurity)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
                var gbdata = baseRepo.GenerateOTPForCompany(CompanyId);
        ...
        public Object ValidateOTPForCompany(string otp, int? nestingLevels, bool includeAllVersions, bool applySecurity)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
                var gbdata = baseRepo.ValidateOTPForCompany(otp);
        ...
        public Object GetDoctorSignatureById(int doctorId, int? nestingLevels, bool includeAllVersions, bool applySecurity)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
                var gbdata = baseRepo.GetDoctorSignatureById(doctorId);
        ...
        public Object GetByDoctorAndCompanyId(int doctorId, int companyId, int? nestingLevels, bool includeAllVersions, bool applySecurity)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
                var gbdata = baseRepo.GetByDoctorAndCompanyId(doctorId, companyId);
        ...
        public Object GetByDoctorAndDates(int DoctorId, int medicalProviderId, DateTime FromDate, DateTime ToDate, int? nestingLevels, bool includeAllVersions, bool applySecurity)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
                var gbdata = baseRepo.GetByDoctorAndDates(DoctorId, medicalProviderId, FromDate, ToDate);
        ...
        public Object GetAllDoctorSpecialityByCompany(int compnayId, int? nestingLevels, bool includeAllVersions, bool applySecurity)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
                var gbdata = baseRepo.GetAllDoctorSpecialityByCompany(compnayId);
        ...
        public Object GetAllDoctorTestSpecialityByCompany(int compnayId, int? nestingLevels, bool includeAllVersions, bool applySecurity)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
                var gbdata = baseRepo.GetAllDoctorTestSpecialityByCompany(compnayId);
                return gbdata;
            }
        ...
        public Object Get1(int param1, int param2, int? nestingLevels, bool includeAllVersions, bool applySecurity)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
                var gbdata = baseRepo.Get1(param1, param2);
        ...
        public Object Get3(int param1, int param2, int? nestingLevels, bool includeAllVersions, bool applySecurity)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
                var gbdata = baseRepo.Get3(param1, param2);
        ...
        public Object SaveIMEVisit(T data)
        {
            try
            {
                if (data == null)
                ...
                {
                    var gbdata = baseRepo.SaveIMEVisit(data);
                    return gbdata;
                }
            }
        ...
        public Object SaveEOVisit(T data)
        {
            try
            {
                if (data == null)
                ...
                {
                    var gbdata = baseRepo.SaveEOVisit(data);
                    return gbdata;
                }
            }
        ...
        public Object AssociatePreferredCompany(string otp, int currentCompanyId, int? nestingLevels, bool includeAllVersions, bool applySecurity)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
                var gbdata = baseRepo.AssociatePreferredCompany(otp, currentCompanyId);
        ...
        public Object AssociateAncillaryProviderWithCompany(int PrefAncillaryProviderId, int CompanyId, int? nestingLevels, bool includeAllVersions, bool applySecurity)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
                var gbdata = baseRepo.AssociateAncillaryProviderWithCompany(PrefAncillaryProviderId, CompanyId);
        ...
        public Object GetOpenCaseCompaniesByPatientId(int PatientId, int? nestingLevels, bool includeAllVersions, bool applySecurity)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
                var gbdata = baseRepo.GetOpenCaseCompaniesByPatientId(PatientId);
        ...
        public Object GetICDTypeCodeByCompanyId(int CompanyId, int? nestingLevels, bool includeAllVersions, bool applySecurity)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
                var gbdata = baseRepo.GetICDTypeCodeByCompanyId(CompanyId);
        ...
        public Object GetDoctorTaxTypes(int? nestingLevels, bool includeAllVersions, bool applySecurity)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
                var gbdata = baseRepo.GetDoctorTaxTypes();
        ...
        public object GetOpenCasesByCompanyWithPatient(int CompanyId, int? nestingLevels, bool includeAllVersions, bool applySecurity)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());

                var refid = baseRepo.GetOpenCasesByCompanyWithPatient(CompanyId);
        ...
        public object GetMasterAndByCompanyId(int CompanyId, int? nestingLevels, bool includeAllVersions, bool applySecurity)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());

                var refid = baseRepo.GetMasterAndByCompanyId(CompanyId);
        ...
        public object Delete(int id, int CompanyId, int? nestingLevels, bool includeAllVersions, bool applySecurity)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());

                var refid = baseRepo.Delete(id, CompanyId);
        ...
        public object GetInsuranceDetails(int id, int CompanyId, int? nestingLevels, bool includeAllVersions, bool applySecurity)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
        ...
        public object GetByCompanyAndAttorneyId(int CompanyId, int AttorneyId, int? nestingLevels, bool includeAllVersions, bool applySecurity)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());

                var refid = baseRepo.GetByCompanyAndAttorneyId(CompanyId, AttorneyId);
        ...
        public object GetMasterAndByCaseId(int CaseId, int? nestingLevels, bool includeAllVersions, bool applySecurity)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());

                var refid = baseRepo.GetMasterAndByCaseId(CaseId);
        ...
        #region Save Referral Patient Visit Unscheduled
        public Object SaveReferralPatientVisitUnscheduled(T data)
        {
            try
            {
                //var gbObject = (GbObject)(object)entity;
                ...
                {
                    var gbdata = baseRepo.SaveReferralPatientVisitUnscheduled(data);
                    return gbdata;
                }
            }
        ...
        public Object GetPatientVisitForDateByLocationId(DateTime ForDate, int LocationId, int? nestingLevels, bool includeAllVersions, bool applySecurity)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
                var gbdata = baseRepo.GetPatientVisitForDateByLocationId(ForDate, LocationId);
        ...
        public Object GetPatientVisitForDateByCompanyId(DateTime ForDate, int CompanyId, int? nestingLevels, bool includeAllVersions, bool applySecurity)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
                var gbdata = baseRepo.GetPatientVisitForDateByCompanyId(ForDate, CompanyId);
        ...
        public Object GetDoctorPatientVisitForDateByLocationId(DateTime ForDate, int DoctorId, int LocationId, int? nestingLevels, bool includeAllVersions, bool applySecurity)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
                var gbdata = baseRepo.GetDoctorPatientVisitForDateByLocationId(ForDate, DoctorId, LocationId);
        ...
        public Object GetDoctorPatientVisitForDateByCompanyId(DateTime ForDate, int DoctorId, int CompanyId, int? nestingLevels, bool includeAllVersions, bool applySecurity)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
                var gbdata = baseRepo.GetDoctorPatientVisitForDateByCompanyId(ForDate, DoctorId, CompanyId);
        ...
        public Object GetAttorneyVisitForDateByCompanyId(DateTime ForDate, int CompanyId, int? nestingLevels, bool includeAllVersions, bool applySecurity)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
                var gbdata = baseRepo.GetAttorneyVisitForDateByCompanyId(ForDate, CompanyId);
        ...
        public Object GetStatisticalDataOnPatientVisit(DateTime FromDate, DateTime ToDate, int CompanyId, int? nestingLevels, bool includeAllVersions, bool applySecurity)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
                var gbdata = baseRepo.GetStatisticalDataOnPatientVisit(FromDate, ToDate, CompanyId);
        ...
        public Object GetOpenAppointmentSlotsForDoctorByCompanyId(DateTime ForDate, int DoctorId, int CompanyId, int? nestingLevels, bool includeAllVersions, bool applySecurity)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
                var gbdata = baseRepo.GetOpenAppointmentSlotsForDoctorByCompanyId(ForDate, DoctorId, CompanyId);
        ...
        public object GetDoctors(T data)
        {
            try
            {
                ...
                {
                    var gbdata = baseRepo.GetDoctors(data);
                    return gbdata;
                }
            }
            catch (DbEntityValidationException ex)
        ...
        public object GetMedicalProviders(T data)
        {
            try
            {
                if (data == null)
                ...
                {
                    var gbdata = baseRepo.GetMedicalProviders(data);
                    return gbdata;
                }
            }
            catch (DbEntityValidationException ex)
        ...
        public Object GetCaseForCompanyId(int CaseId, int CompanyId, int? nestingLevels, bool includeAllVersions, bool applySecurity)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
                var gbdata = baseRepo.GetCaseForCompanyId(CaseId, CompanyId);
        ...
        public Object GetByRoomTestAndCompanyId(int roomTestId, int companyId, int? nestingLevels, bool includeAllVersions, bool applySecurity)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
                var gbdata = baseRepo.GetByRoomTestAndCompanyId(roomTestId, companyId);
                return gbdata;
            }
            catch (GbException gbe)
            {
        ...
        public object UpdatePrefferedProcedureCode(int id)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());

                var refid = baseRepo.UpdatePrefferedProcedureCode(id);
        ...
        public Object DisassociateDoctorWithCompanyandAppointment(int DoctorId, int CompanyId, int? nestingLevels, bool includeAllVersions, bool applySecurity)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
                var gbdata = baseRepo.DisassociateDoctorWithCompanyandAppointment(DoctorId, CompanyId);
        ...
        public Object GetUserByUserName(string UserName, int? nestingLevels, bool includeAllVersions, bool applySecurity)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
                var gbdata = baseRepo.GetUserByUserName(UserName);
        ...
        public Object Mapusertothecompnay(string UserName, int CompanyId, int CurrentUserId, int? nestingLevels, bool includeAllVersions, bool applySecurity)
        {
            ...
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
                var gbdata = baseRepo.Mapusertothecompnay(UserName, CompanyId, CurrentUserId);
        ...
        public Object GetUserByIDAndCompnayID(int id, int CompanyId, int? nestingLevels, bool includeAllVersions, bool applySecurity)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
                var gbdata = baseRepo.GetUserByIDAndCompnayID(id, CompanyId);
        ...
        public Object GetDoctorByIDAndCompnayID(int id, int CompanyId, int? nestingLevels, bool includeAllVersions, bool applySecurity)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
                var gbdata = baseRepo.GetDoctorByIDAndCompnayID(id, CompanyId);
                return gbdata;
            }
            catch (GbException gbe)
            {
        ...
        public Object GetByLocationRoomDoctorId(int LocationId, int DoctorId)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
                var gbdata = baseRepo.GetByLocationRoomDoctorId(LocationId, DoctorId);
        ...
        public Object GetAllProcedureCodesbySpecaltyCompanyId(int CompanyId, int SpecialtyId)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
                var gbdata = baseRepo.GetAllProcedureCodesbySpecaltyCompanyId(CompanyId, SpecialtyId);
        ...
        public Object GetProcedureCodesbySpecialtyCompanyIdforVisit(int CompanyId, int SpecialtyId)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
        ...
        public Object GetAllProcedureCodesbyRoomTestCompanyIdforVisit(int CompanyId, int RoomTestId)
        {
            ...
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
                var gbdata = baseRepo.GetAllProcedureCodesbyRoomTestCompanyIdforVisit(CompanyId, RoomTestId);
        ...
        public Object GetByLocationDoctorAndCompanyId(int locationId, int doctorId, int companyId)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
                var gbdata = baseRepo.GetByLocationDoctorAndCompanyId(locationId, doctorId, companyId);
        ...
        public Object GetByLocationDoctorAndRoomId(int locationId, int doctorId, int roomId)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
        ...
        public Object GetVisitStatusbyPatientVisitSpecialityId(int PatientVisitId, int specialityId)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
                var gbdata = baseRepo.GetVisitStatusbyPatientVisitSpecialityId(PatientVisitId, specialityId);
        ...
        public Object GetVisitStatusbyPatientVisitRoomTestId(int PatientVisitId, int roomTestId)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
                var gbdata = baseRepo.GetVisitStatusbyPatientVisitRoomTestId(PatientVisitId, roomTestId);
        ...
        public Object GetPatientVisitUnscheduledByCompanyId(int CompanyId)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
                var gbdata = baseRepo.GetPatientVisitUnscheduledByCompanyId(CompanyId);
        ...
        public Object SetUpdatePrefferedProcedureCodeMultiple(List<T> data)
        {
            try
            {
                //var gbObject = (GbObject)(object)entity;
                ...
                var gbdata = baseRepo.SetUpdatePrefferedProcedureCodeMultiple(data);
                return gbdata;
        ...
        public Object RemoveUpdatePrefferedProcedureCodeMultiple(List<T> data)
        {
            try
            {
                //var gbObject = (GbObject)(object)entity;
                ...
                var gbdata = baseRepo.RemoveUpdatePrefferedProcedureCodeMultiple(data);
                return gbdata;
        ...
        public Object GetDoctorsByCompanyIdAndSpeciality(int companyId, int specialtyId, int? nestingLevels, bool includeAllVersions, bool applySecurity)
        {
            ...
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
                var gbdata = baseRepo.GetDoctorsByCompanyIdAndSpeciality(companyId, specialtyId);
                return gbdata;
            }
        ...
        public Object GetDoctorsByCompanyIdAndTestSpeciality(int companyId, int roomTestId, int? nestingLevels, bool includeAllVersions, bool applySecurity)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
                var gbdata = baseRepo.GetDoctorsByCompanyIdAndTestSpeciality(companyId, roomTestId);
                return gbdata;
            }
        ...
        public Object GetInhouseReferralByCompanyId(int companyId, int? nestingLevels, bool includeAllVersions, bool applySecurity)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
                var gbdata = baseRepo.GetInhouseReferralByCompanyId(companyId);
        ...
        public Object GetInhouseReferralByDoctorAndCompanyId(int doctorId, int companyId, int? nestingLevels, bool includeAllVersions, bool applySecurity)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
                var gbdata = baseRepo.GetInhouseReferralByDoctorAndCompanyId(doctorId, companyId);
        ...
        public Object GetByRoomInAllAppCompany(int roomTestId, int companyId, int? nestingLevels, bool includeAllVersions, bool applySecurity)
        {
            ...
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
                var gbdata = baseRepo.GetByRoomInAllAppCompany(roomTestId, companyId);
        ...
        public Object GetByPrefMedProviderCompanyName(string CompanyName)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
                var gbdata = baseRepo.GetByPrefMedProviderCompanyName(CompanyName);
        ...
        public Object GetbyCompanyName(string CompanyName)
        {
            ...
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
                var gbdata = baseRepo.GetbyCompanyName(CompanyName);
        ...
        public Object GetPreferredMedicalProviderbyCompanyId(int CompanyId)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
                var gbdata = baseRepo.GetPreferredMedicalProviderbyCompanyId(CompanyId);
        ...
        public Object AssociateLocationToUser(T data)
        {
            try
            {
                ...
                {
                    var gbdata = baseRepo.AssociateLocationToUser(data);
                    return gbdata;
                }
            }
        ...
        public Object AssociateUserToLocations(T data)
        {
            try
            {
                //var gbObject = (GbObject)(object)entity;
                ...
                {
                    var gbdata = baseRepo.AssociateUserToLocations(data);
                    return gbdata;
                }
            }
        ...
        public object DeleteAllAppointmentsandUserLocationSchedule(T entity)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());

                var res = baseRepo.DeleteAllAppointmentsandUserLocationSchedule(entity);
        ...
        public Object GetByUserId(int UserId, int? nestingLevels, bool includeAllVersions, bool applySecurity)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
        ...
        public Object DisassociateUserWithCompany(int UserId, int CompanyId, int? nestingLevels, bool includeAllVersions, bool applySecurity)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
                var gbdata = baseRepo.DisassociateUserWithCompany(UserId, CompanyId);
        ...
        public Object DisassociateUserWithCompanyandAppointment(int UserId, int CompanyId, int? nestingLevels, bool includeAllVersions, bool applySecurity)
        {
            try
            {
                BaseEntityRepo baseRepo = RepoFactory.GetRepo<T>(dbContextProvider.GetGbDBContext());
                var gbdata = baseRepo.DisassociateUserWithCompanyandAppointment(UserId, CompanyId);
