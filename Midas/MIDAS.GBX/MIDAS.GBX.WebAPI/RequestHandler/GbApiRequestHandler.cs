...
namespace MIDAS.GBX.WebAPI
{
    public class GbApiRequestHandler<T> : IRequestHandler<T>
    {
        ...
        public HttpResponseMessage GetAllDoctorSpecialityByCompany(HttpRequestMessage request, int compnayId)
        {
            var objResult = dataAccessManager.GetAllDoctorSpecialityByCompany(compnayId);
        ...
        public HttpResponseMessage GetAllDoctorTestSpecialityByCompany(HttpRequestMessage request, int compnayId)
        {
            var objResult = dataAccessManager.GetAllDoctorTestSpecialityByCompany(compnayId);
        ...
        public HttpResponseMessage AssociateAncillaryProviderWithCompany(HttpRequestMessage request, int PreAncillaryProviderId, int CompanyId)
        {
            var objResult = dataAccessManager.AssociateAncillaryProviderWithCompany(PreAncillaryProviderId, CompanyId);
            try
            {
                return request.CreateResponse(HttpStatusCode.Created, objResult);
            }
        ...
        public HttpResponseMessage GetICDTypeCodeByCompanyId(HttpRequestMessage request, int CompanyId)
        {
            var objResult = dataAccessManager.GetICDTypeCodeByCompanyId(CompanyId);
            try
            {
                return request.CreateResponse(HttpStatusCode.Created, objResult);
            }
        ...
        public HttpResponseMessage SaveReferralPatientVisitUnscheduled(HttpRequestMessage request, T gbObject)
        {
            var objResult = dataAccessManager.SaveReferralPatientVisitUnscheduled(gbObject);
        ...
        public HttpResponseMessage GetOpenAppointmentSlotsForDoctorByCompanyId(HttpRequestMessage request, DateTime ForDate, int DoctorId, int CompanyId)
        {
            var objResult = dataAccessManager.GetOpenAppointmentSlotsForDoctorByCompanyId(ForDate, DoctorId, CompanyId);
            try
            {
                return request.CreateResponse(HttpStatusCode.Created, objResult);
            }
        ...
        public HttpResponseMessage GetByRoomTestAndCompanyId(HttpRequestMessage request, int roomTestId, int companyId)
        {
            var objResult = dataAccessManager.GetByRoomTestAndCompanyId(roomTestId, companyId);
            try
            {
                return request.CreateResponse(HttpStatusCode.Created, objResult);
            }
        ...
        public HttpResponseMessage UpdatePrefferedProcedureCode(HttpRequestMessage request, int id)
        {
            var res = dataAccessManager.UpdatePrefferedProcedureCode(id);
            if (id > 0)
            {
                return request.CreateResponse(HttpStatusCode.Accepted, res);
            }
        ...
        public HttpResponseMessage DeleteAllAppointmentsandDoctorLocationSchedule(HttpRequestMessage request, T gbObject)
        {
            var res = dataAccessManager.DeleteAllAppointmentsandDoctorLocationSchedule(gbObject);
            if (res != null)
            {
                return request.CreateResponse(HttpStatusCode.Accepted, res);
            }
        ...
        public HttpResponseMessage DisassociateDoctorWithCompanyandAppointment(HttpRequestMessage request, int DoctorId, int CompanyId)
        {
            var objResult = dataAccessManager.DisassociateDoctorWithCompanyandAppointment(DoctorId, CompanyId);
        ...
        {
            var objResult = dataAccessManager.GetUserByUserName(UserName);
            try
            {
                var res = (object)objResult;
        ...
        public HttpResponseMessage Mapusertothecompnay(HttpRequestMessage request, string UserName, int CompanyId,int CurrentUserId)
        {
            var objResult = dataAccessManager.Mapusertothecompnay(UserName, CompanyId, CurrentUserId);
            try
            {
                var res = (object)objResult;
        ...
        public HttpResponseMessage GetUserByIDAndCompnayID(HttpRequestMessage request, int id, int CompanyId)
        {
            var objResult = dataAccessManager.GetUserByIDAndCompnayID(id, CompanyId);
            try
            {
                var res = (object)objResult;
        ...
        public HttpResponseMessage GetDoctorByIDAndCompnayID(HttpRequestMessage request, int id, int CompanyId)
        {
            var objResult = dataAccessManager.GetDoctorByIDAndCompnayID(id, CompanyId);
            try
            {
                var res = (object)objResult;
        ...
        public HttpResponseMessage GetByLocationRoomDoctorId(HttpRequestMessage request, int LocationId, int DoctorId)
        {
            var objResult = dataAccessManager.GetByLocationRoomDoctorId(LocationId, DoctorId);
            try
            {
                return request.CreateResponse(HttpStatusCode.Created, objResult);
            }
        ...
        public HttpResponseMessage GetAllProcedureCodesbySpecaltyCompanyId(HttpRequestMessage request, int CompanyId, int SpecialtyId)
        {
            var objResult = dataAccessManager.GetAllProcedureCodesbySpecaltyCompanyId(CompanyId, SpecialtyId);
            try
            {
                return request.CreateResponse(HttpStatusCode.Created, objResult);
            }
        ...
        public HttpResponseMessage GetProcedureCodesbySpecialtyCompanyIdforVisit(HttpRequestMessage request, int CompanyId, int SpecialtyId)
        {
            var objResult = dataAccessManager.GetProcedureCodesbySpecialtyCompanyIdforVisit(CompanyId, SpecialtyId);
            try
            {
                return request.CreateResponse(HttpStatusCode.Created, objResult);
            }
        ...
        public HttpResponseMessage GetAllProcedureCodesbyRoomTestCompanyIdforVisit(HttpRequestMessage request, int CompanyId, int RoomTestId)
        {
            var objResult = dataAccessManager.GetAllProcedureCodesbyRoomTestCompanyIdforVisit(CompanyId, RoomTestId);
            try
            {
                return request.CreateResponse(HttpStatusCode.Created, objResult);
            }
        ...
        public HttpResponseMessage GetByLocationDoctorAndCompanyId(HttpRequestMessage request, int locationId, int doctorId, int companyId)
        {
            var objResult = dataAccessManager.GetByLocationDoctorAndCompanyId(locationId, doctorId, companyId);
            try
            {
                return request.CreateResponse(HttpStatusCode.Created, objResult);
            }
        ...
        public HttpResponseMessage GetPatientVisitUnscheduledByCompanyId(HttpRequestMessage request, int CompanyId)
        {
            var objResult = dataAccessManager.GetPatientVisitUnscheduledByCompanyId(CompanyId);
            try
            {
                return request.CreateResponse(HttpStatusCode.Created, objResult);
            }
