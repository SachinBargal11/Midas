...
namespace MIDAS.GBX.WebAPI
{
    public interface IRequestHandler<T> 
    {
        ...
        HttpResponseMessage GetAllDoctorSpecialityByCompany(HttpRequestMessage request, int compnayId);
        HttpResponseMessage GetAllDoctorTestSpecialityByCompany(HttpRequestMessage request, int compnayId);
        ...
        HttpResponseMessage GetDoctorSignatureById(HttpRequestMessage request, int doctorId);
        ...
        HttpResponseMessage AssociateAncillaryProviderWithCompany(HttpRequestMessage request, int PrefAncillaryProviderId, int CompanyId);
        ...
        HttpResponseMessage GetByRoomTestAndCompanyId(HttpRequestMessage request, int roomTestId, int companyId);
        HttpResponseMessage UpdatePrefferedProcedureCode(HttpRequestMessage request, int id);
        HttpResponseMessage DeleteAllAppointmentsandDoctorLocationSchedule(HttpRequestMessage request, T gbObject);
        HttpResponseMessage DeleteObj(HttpRequestMessage request, T gbObject);
        HttpResponseMessage DisassociateDoctorWithCompanyandAppointment(HttpRequestMessage request, int DoctorId, int CompanyId);
        HttpResponseMessage GetUserByUserName(HttpRequestMessage request, string UserName);
        HttpResponseMessage Mapusertothecompnay(HttpRequestMessage request, string UserName, int CompanyId,int CurrentUserId);
        HttpResponseMessage GetUserByIDAndCompnayID(HttpRequestMessage request, int id, int CompanyId);
        HttpResponseMessage GetDoctorByIDAndCompnayID(HttpRequestMessage request, int id, int CompanyId);
        HttpResponseMessage GetByLocationRoomDoctorId(HttpRequestMessage request, int id, int DoctorId);
        HttpResponseMessage GetAllProcedureCodesbySpecaltyCompanyId(HttpRequestMessage request, int CompanyId, int SpecialtyId);
        HttpResponseMessage GetProcedureCodesbySpecialtyCompanyIdforVisit(HttpRequestMessage request, int CompanyId, int SpecialtyId);
        ...
        HttpResponseMessage GetUnAssignedByCompanyId(HttpRequestMessage request, int CompanyId);
    }
}
