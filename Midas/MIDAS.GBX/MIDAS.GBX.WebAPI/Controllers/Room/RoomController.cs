...
namespace MIDAS.GBX.WebAPI.Controllers
{
    ...
    public class RoomController : ApiController
    {
        ...
        [HttpGet]
        [Route("getByLocationId/{locationId}/{DoctorId}")]
        public HttpResponseMessage GetByLocationRoomDoctorId(int LocationId, int DoctorId)
        {
            return requestHandler.GetByLocationRoomDoctorId(Request, LocationId, DoctorId);
        }
