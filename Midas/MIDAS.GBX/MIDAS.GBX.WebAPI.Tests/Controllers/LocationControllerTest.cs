...
namespace MIDAS.GBX.WebAPI.Tests.Controllers
{
    ...
    public class LocationControllerTest
    {
        ...
        public void SaveLocationTest()
        {
            ...
            savelocation.location.Company = new Company();
            ...
            savelocation.location.Company.AddressInfo = new AddressInfo();
            savelocation.location.Company.AddressInfo.ID = 1111;
            savelocation.location.Company.AddressInfo.City = "Mumbai";
            savelocation.location.Company.AddressInfo.Country = "India";
            savelocation.location.Company.AddressInfo.ZipCode = "400603";

            savelocation.location.Company.ContactInfo = new ContactInfo();
            savelocation.location.Company.ContactInfo.ID = 2222;
            savelocation.location.Company.ContactInfo.CellPhone = "2345678906";
            savelocation.location.Company.ContactInfo.EmailAddress = "milind.k@codearray.tech";
            savelocation.location.Company.ContactInfo.HomePhone = "451245135";
            savelocation.location.Company.ContactInfo.WorkPhone = "187546521";
            savelocation.location.Company.ContactInfo.FaxNo = "9875421545";
        ...
        public void DeleteLocationTest()
        {
            ...
            controller.Delete(Loc);
        }

        [TestMethod]
        public void IsuniqueLocationTest()
        {
            LocationController controller = new LocationController();
            Location Loc = new Location();
            Loc.ID = 10;
