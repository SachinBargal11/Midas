...
ALTER TABLE [dbo].[Patient2]  WITH CHECK ADD  CONSTRAINT [FK_Patient2_Location] FOREIGN KEY([LocationID])
...
ALTER TABLE [dbo].[Patient2]  WITH CHECK ADD  CONSTRAINT [FK_Patient2_User] FOREIGN KEY([id])
REFERENCES [dbo].[User] ([id])
GO

ALTER TABLE [dbo].[Patient2] CHECK CONSTRAINT [FK_Patient2_User]
GO

ALTER TABLE [dbo].[Patient2]  WITH CHECK ADD  CONSTRAINT [FK_Patient2_MaritalStatus] FOREIGN KEY([MaritalStatus])
REFERENCES [dbo].[MaritalStatus] ([id])
GO

ALTER TABLE [dbo].[Patient2] CHECK CONSTRAINT [FK_Patient2_MaritalStatus]
GO
