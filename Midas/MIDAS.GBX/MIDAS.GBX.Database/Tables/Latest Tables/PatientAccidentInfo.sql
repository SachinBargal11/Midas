...
BEGIN
    ...
    (
        ...
        [PoliceAtScene] BIT NULL DEFAULT 0, 
        [Precinct] NVARCHAR(64) NULL, 
        [ReportNumber] [NVARCHAR](128) NULL, 
	    [PatientTypeId] [TINYINT] NOT NULL,
        [WearingSeatBelts] BIT NULL DEFAULT 0, 
        [AirBagsDeploy] BIT NULL DEFAULT 0,  
        [PhotosTaken] BIT NULL DEFAULT 0, 
        [AccidentDescription] NVARCHAR(1024) NULL, 
        [Witness] BIT NULL DEFAULT 0, 
        [DescribeInjury] [NVARCHAR](1024) NULL, 
	    [HospitalName] [NVARCHAR](128) NULL, 
        [Ambulance] BIT NULL DEFAULT 0, 
	    [HospitalAddressInfoId] [INT] NOT NULL, 
        [TreatedAndReleased] BIT NULL DEFAULT 0, 
        [Admitted] BIT NULL DEFAULT 0, 
	    [DateOfAdmission] DATETIME NULL, 
        [XRaysTaken] BIT NULL DEFAULT 0, 
