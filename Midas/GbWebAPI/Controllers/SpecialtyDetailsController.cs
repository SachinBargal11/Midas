...
{
    [RoutePrefix("midasapi/SpecialtyDetails")]
    [AllowAnonymous]
    public class SpecialtyDetailsController : ApiController
    {

        private IRequestHandler<SpecialityDetails> requestHandler;
        public SpecialtyDetailsController()
        {
            requestHandler = new GbApiRequestHandler<SpecialityDetails>();
        }
        ...
        [HttpPut]
        [AllowAnonymous]
        public HttpResponseMessage Put([FromBody]SpecialityDetails User)
        {
        ...
        [Route("Delete")]
        [AllowAnonymous]
        public HttpResponseMessage Delete([FromBody]SpecialityDetails doctor)
        {
        ...
        [HttpGet]
        [Route("IsUnique")]
        public HttpResponseMessage IsUnique([FromBody]SpecialityDetails doctor)
        {
