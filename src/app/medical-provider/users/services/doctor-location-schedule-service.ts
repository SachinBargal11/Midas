...
export class DoctorLocationScheduleService {
    ...
    getDoctorLocationScheduleByDoctorIdCompanyId(companyId:Number,doctorId: Number): Observable<any> {
        let promise: Promise<DoctorLocationSchedule[]> = new Promise((resolve, reject) => {
            return this._http.get(environment.SERVICE_BASE_URL + '/DoctorLocationSchedule/getByDoctorAndCompanyId/' + doctorId + '/' + companyId, {
                headers: this._headers
            }).map(res => res.json())
                .subscribe((data: any) => {
                    let schedules: DoctorLocationSchedule[];
    ...
    deleteDoctorLocationSchedule(doctorLocationSchedule: DoctorLocationSchedule): Observable<DoctorLocationSchedule> {        
        let promise = new Promise((resolve, reject) => {
            return this._http.post(environment.SERVICE_BASE_URL + '/DoctorLocationSchedule/Delete', JSON.stringify(doctorLocationSchedule), {
                headers: this._headers
            })
                .map(res => res.json())
                .subscribe((schedule) => {
    ...
    deleteAppointmentsDoctorLocationSchedule(doctorLocationSchedule: DoctorLocationSchedule): Observable<DoctorLocationSchedule> {        
        let promise = new Promise((resolve, reject) => {
            return this._http.post(environment.SERVICE_BASE_URL + '/DoctorLocationSchedule/DeleteAllAppointmentsandDoctorLocationSchedule',  JSON.stringify(doctorLocationSchedule), {
                headers: this._headers
            })
                .map(res => res.json())
                .subscribe((schedule) => {
