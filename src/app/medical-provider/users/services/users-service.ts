...
export class UsersService {
    ...
    getUserByUserName(userName: String): Observable<User> {
        ...
        let promise: Promise<User> = new Promise((resolve, reject) => {
            return this._http.post(environment.SERVICE_BASE_URL + '/User/getUserByUserName/' , JSON.stringify(requestData), {
                headers: this._headers
            }).map(res => res.json())
                .subscribe((userData: any) => {
                    let parsedUser: User = null;
    ...
    mapUserToCompnay(userName: String ,companyId: number,CurrentUserId: number): Observable<any> {
        ...
        let promise: Promise<any> = new Promise((resolve, reject) => {
            return this._http.post(environment.SERVICE_BASE_URL + '/User/mapusertothecompnay/' , JSON.stringify(requestData), {
                headers: this._headers
            }).map(res => res.json())
            .subscribe((data: any) => {
                resolve(data);
    ...
    getUserByCompanyId(userId: Number,companyId: Number): Observable<User> {
        let requestData = {
            companyId: companyId,
            CurrentUserId: userId
        }
        let promise: Promise<User> = new Promise((resolve, reject) => {
            return this._http.post(environment.SERVICE_BASE_URL + '/User/getUserByIdAndCompany/' , JSON.stringify(requestData), {
                headers: this._headers
            }).map(res => res.json())
                .subscribe((userData: any) => {
                    let parsedUser: User = null;
