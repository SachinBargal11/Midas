...
import { AddDiagnosisCodeComponent } from './add-diagnosis-code-master';
import { DocumentTypeComponent } from './document-type';
import { AccountGeneralSettingComponent } from './account-general-settings';
import { DiagnosisCodeMasterComponent } from './diagnosis-code-master';
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                canActivate: [ValidateActiveSession],
                data: {
                    breadcrumb: 'Diagnosis codes'
                },
                children: [
                    {
                        path: '',
                        component: DiagnosisCodeMasterComponent,
                        data: {
                            breadcrumb: 'root'
                        }
                    },
                    {
                        path: 'add',
                        component: AddDiagnosisCodeComponent,
                        canActivate: [ValidateActiveSession],
                        data: {
                            breadcrumb: 'Add diagnosis'
                        }
                    }
                ]
            },
