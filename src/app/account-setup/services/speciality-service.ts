...
export class SpecialityService {
    ...
    getSpecialitiesByCompnayId(compnayId: number): Observable<Speciality[]> {
        let promise: Promise<Speciality[]> = new Promise((resolve, reject) => {
            return this._http.get(`${environment.SERVICE_BASE_URL}/Doctor/getAllDoctorSpecialityByCompany/${compnayId}`, {
                headers: this._headers
            })
                .map(res => res.json())
                .subscribe((specialityData: Array<Object>) => {
