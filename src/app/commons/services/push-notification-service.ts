...
export class PushNotificationService {
    ...
    getAllGroupEventsByGroupId(): Observable<any[]> {
        let promise: Promise<any[]> = new Promise((resolve, reject) => {
            return this._http.get(environment.NOTIFICATION_SERVER_URL + '/NotificationManager/GetGroupEventsByGroupID?groupid=6', {
                headers: this._headers
            })
                .map(res => res.json())
                .subscribe((data: Array<Object>) => {
    ...
    getAllGroupEvents(): Observable<any[]> {
        let promise: Promise<any[]> = new Promise((resolve, reject) => {
            return this._http.get(environment.NOTIFICATION_SERVER_URL + '/NotificationManager/GetGroupEvents?applicationName=Midas&groupname=Ancillary', {
                headers: this._headers
            })
                .map(res => res.json())
                .subscribe((data: Array<Object>) => {
