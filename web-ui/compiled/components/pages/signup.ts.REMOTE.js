System.register(['@angular/core', '@angular/forms', '@angular/router', 'ng2-bootstrap', '../../utils/AppValidators', '../elements/loader', '../../services/authentication-service', '../../models/account-details', '../../models/account', '../../models/user', '../../models/contact', '../../models/address', '../../stores/session-store', '../../stores/notifications-store', 'angular2-notifications', 'primeng/primeng'], function(exports_1, context_1) {
    ...
    var core_1, forms_1, router_1, ng2_bootstrap_1, AppValidators_1, loader_1, authentication_service_1, account_details_1, account_1, user_1, contact_1, address_1, session_store_1, notifications_store_1, angular2_notifications_1, primeng_1;
    var SignupComponent;
    return {
        setters:[
            function (core_1_1) {
...
//# sourceMappingURL=signup.ts.REMOTE.js.map