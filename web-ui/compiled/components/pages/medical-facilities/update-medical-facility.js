System.register(['@angular/core', '@angular/forms', '@angular/router', '../../../utils/AppValidators', '../../elements/loader', '../../../models/medical-facility', '../../../models/medical-facility-details', '../../../models/user', '../../../models/account', '../../../models/contact', '../../../models/address', '../../../stores/session-store', '../../../stores/notifications-store', '../../../models/notification', 'moment', 'primeng/primeng', '../../../stores/medical-facilities-store', '../../../services/medical-facility-service', '../../../stores/states-store', '../../../services/state-service', '@angular/http', '../../../pipes/limit-array-pipe'], function(exports_1, context_1) {
    ...
    var UpdateMedicalFacilityComponent;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function() {
            UpdateMedicalFacilityComponent = (function () {
                function UpdateMedicalFacilityComponent(_stateService, _statesStore, _medicalFacilitiesStore, fb, _router, _route, _notificationsStore, _sessionStore, _elRef) {
                    var _this = this;
                    ...
                    this._elRef = _elRef;
                    this.medicalFacilityDetail = new medical_facility_details_1.MedicalFacilityDetail({});
                    this.medicalfacility = new medical_facility_1.MedicalFacility({});
                    this.contactInfo = new contact_1.ContactInfo({});
                    ...
                    this._route.params.subscribe(function (routeParams) {
                        var mfId = parseInt(routeParams.id);
                        var result = _this._medicalFacilitiesStore.fetchMedicalFacilityById(mfId);
                        result.subscribe(function (medicalFacilityDetail) {
                            _this.medicalfacility = medicalFacilityDetail.medicalfacility;
                            _this.contactInfo = medicalFacilityDetail.contactInfo;
                            _this.address = medicalFacilityDetail.address;
                        }, function (error) {
                ...
                UpdateMedicalFacilityComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this._stateService.getStates()
                        .subscribe(function (states) { return _this.states = states; });
                };
                UpdateMedicalFacilityComponent.prototype.updateMedicalFacility = function () {
                    var _this = this;
                ...
                UpdateMedicalFacilityComponent = __decorate([
                    core_1.Component({
                    ...
                    __metadata('design:paramtypes', [state_service_1.StateService, states_store_1.StatesStore, medical_facilities_store_1.MedicalFacilityStore, forms_1.FormBuilder, router_1.Router, router_1.ActivatedRoute, notifications_store_1.NotificationsStore, session_store_1.SessionStore, core_1.ElementRef])
                ], UpdateMedicalFacilityComponent);
                return UpdateMedicalFacilityComponent;
            }());
            exports_1("UpdateMedicalFacilityComponent", UpdateMedicalFacilityComponent);
        }
    }
});
//# sourceMappingURL=update-medical-facility.js.map