System.register(['@angular/core', '@angular/forms', '@angular/router', '../../../utils/AppValidators', '../../elements/loader', '../../../stores/users-store', '../../../models/user', '../../../services/users-service', '../../../models/account-details', '../../../models/account', '../../../models/contact', '../../../models/address', '../../../stores/session-store', '../../../stores/notifications-store', '../../../models/notification', 'moment', 'primeng/primeng', '../../../stores/states-store', '../../../services/state-service', '@angular/http', '../../../pipes/limit-array-pipe'], function(exports_1, context_1) {
    ...
    var core_1, forms_1, router_1, AppValidators_1, loader_1, users_store_1, user_1, users_service_1, account_details_1, account_1, contact_1, address_1, session_store_1, notifications_store_1, notification_1, moment_1, primeng_1, states_store_1, state_service_1, http_1, limit_array_pipe_1;
    ...
    return {
        ...
        execute: function() {
            AddUserComponent = (function () {
                function AddUserComponent(_stateService, _statesStore, _userService, fb, _router, _notificationsStore, _sessionStore, _usersStore, _elRef) {
                ...
                AddUserComponent = __decorate([
                    ...
                    __metadata('design:paramtypes', [state_service_1.StateService, states_store_1.StatesStore, users_service_1.UsersService, forms_1.FormBuilder, router_1.Router, notifications_store_1.NotificationsStore, session_store_1.SessionStore, users_store_1.UsersStore, core_1.ElementRef])
                ], AddUserComponent);
