System.register(['@angular/core', '@angular/router', './pages/login', './pages/signup', './pages/dashboard', './pages/patients/patients-shell', './elements/app-header', './elements/main-nav', '../stores/session-store', './elements/notification', '../stores/notifications-store', './pages/change-password', './pages/users/add-user', './pages/users/users-list', './pages/providers/add-provider', '../stores/states-store', '../services/state-service'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, login_1, signup_1, dashboard_1, patients_shell_1, app_header_1, main_nav_1, session_store_1, notification_1, notifications_store_1, change_password_1, add_user_1, users_list_1, add_provider_1, states_store_1, state_service_1;
    var AppRoot;
    return {
        setters:[
            function (core_1_1) {
