    ...
    return {
        ...
        execute: function() {
            ValidateActiveSession = (function () {
                function ValidateActiveSession(_sessionStore, _router) {
                    this._sessionStore = _sessionStore;
                    this._router = _router;
                }
                ValidateActiveSession.prototype.canActivate = function (next, state) {
                ...
                ValidateActiveSession = __decorate([
                    core_1.Injectable(), 
                    __metadata('design:paramtypes', [session_store_1.SessionStore, router_1.Router])
                ], ValidateActiveSession);
                return ValidateActiveSession;
            }());
            exports_1("ValidateActiveSession", ValidateActiveSession);
        }
    }
});
//# sourceMappingURL=validate-active-session.js.map