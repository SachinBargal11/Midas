...
//import { PatientsStore } from '../../cases/stores/patients-store';
...
export class CaseEmployerComponent implements OnInit {
    ...
    constructor(
        ...
        this._route.parent.params.subscribe((routeParams: any) => {
            ...
            this.getCurrentEmployer(this.caseId);
        });
    ...
    getCurrentEmployer(caseId) {
        this.progressBarService.show();
        let result = this._employerStore.getCurrentEmployer(caseId);
        result.subscribe(
            (employer: Employer) => {
                this.employer = employer;
                this.currentEmployer = this.employer;
