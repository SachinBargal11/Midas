...
@Component({
    selector: 'case-document-packeting',
    templateUrl: './case-document-packeting.html'
})

export class CaseDocumentPacketingComponent implements OnInit {
    ...
    getDocuments() {
        ...
        this._casesStore.getDocumentsForCaseId(this.caseId)
            .subscribe(document => {
                this.documents = _.filter(document, (currDocument: CaseDocument) => {
                    let afterDot = currDocument.document.documentName.substr(currDocument.document.documentName.indexOf('.'));
                    return currDocument.document.documentType == '' && currDocument.document.documentName.substr(currDocument.document.documentName.indexOf('.')) == '.zip';
                })
