...
import { AddTestSpecialityDetailsComponent } from '../test-speciality-details/add-test-speciality-details';
import { EditTestSpecialityDetailsComponent } from '../test-speciality-details/edit-test-speciality-details';
...
export const SpecialityRoutes: Routes = [
    ...
    },
    {
        path: '',
        pathMatch: 'full',
        redirectTo: 'specialities/test-speciality'
    },
    {
        path: 'specialities/test-speciality',
        component: ShellComponent,
        canActivate: [ValidateActiveSession],
        data: {
            breadcrumb: 'specialities / test-speciality'
        },
        children: [
            {
                path: '',
            ...
            },
            {
                ...
                children: [
                    {
                        path: 'add',
                        component: AddTestSpecialityDetailsComponent,
                        canActivate: [ValidateActiveSession],
                        data: {
                            breadcrumb: 'Add Test Speciality Detail'
                        }
                    },
                    {
                        path: 'edit',
                        component: EditTestSpecialityDetailsComponent,
                        canActivate: [ValidateActiveSession],
                        data: {
                            breadcrumb: 'Test Speciality Detail'
                        }
                    }
                ]
            }
