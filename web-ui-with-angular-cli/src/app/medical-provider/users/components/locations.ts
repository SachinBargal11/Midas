...
export class LocationsComponent implements OnInit {
    ...
    loadLocations() {
        ...
        this._doctorLocationScheduleStore.getDoctorLocationScheduleByDoctorIdCompanyId(this._sessionStore.session.currentCompany.id, this.userId)
            .subscribe(
            (data) => {
    ...
    deleteLocation(currentLocation:DoctorLocationSchedule) {
                    ...
                    (response) => {
                        ...
                        if(response.errorLevel == 2)
                        {
                            this.confirmationService.confirm({
                                ...
                                accept: () => {
                                    let result1;
                                    result1 = this._doctorLocationScheduleStore.deleteAppointmentsDoctorLocationSchedule(currentLocation);
                                    result1.subscribe(
                                        (response) => {
                                            let notification = new Notification({
                                                'title': 'Location deleted successfully!',
